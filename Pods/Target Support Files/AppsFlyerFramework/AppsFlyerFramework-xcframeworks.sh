...
install_xcframework "${PODS_ROOT}/AppsFlyerFramework/AppsFlyerLib.xcframework" "AppsFlyerFramework/Main" "framework" "ios-arm64_x86_64-maccatalyst" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
